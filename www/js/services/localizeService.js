  ...
  .factory('localize', ['$http', '$rootScope', '$window', '$filter', function ($http, $rootScope, $window, $filter) {
    ...
    var localize = {
      ...
      setSelectedLanguage: function (value) {
        localize.selectedLanguage = value;
      },
      ...
      buildUrl: function () {
        ...
        //add by yuval- always use hebrew
        localize.language = "he";
        if (!localize.language) {

          lang = $rootScope.appLanguage;
          if (!lang) {
            ...
            if (lang.toLowerCase() == "he" || lang.toLowerCase() == "he-il") {
              lang = "he";
            }
        ...
        return 'js/resources/resources-locale_' + lang + '.js';
      },
      ...
      initLocalizedResources: function () {
        ...
        $http({ method: "GET", url: url, cache: false }).success(
          localize.successCallback
        ).error(function () {
          // the request failed set the url to the default resource file

          var url = 'js/resources/resources-locale_en.js';
      ...
      getLocalizedString: function (value) {
        ...
        if ((localize.dictionary !== []) && (localize.dictionary.length > 0)) {
          ...
          if (entry == null) {
            console.log('cant find resource for:"' + value + '"')
            result = "";
          } else {
            // set the result
            result = entry.value;
