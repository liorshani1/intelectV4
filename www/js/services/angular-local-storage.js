            ...
            var addToCookies = function (key, value) {
                ...
                try {
                    ...
                    if (value === null) {
                        ...
                        expiryDate.setTime(expiryDate.getTime() + (cookie.expiry * 24 * 60 * 60 * 1000* 12));
                        expiry = "; expires=" + expiryDate.toGMTString();
                    }
                    if (!!key) {
                        ...
                        {
                            document.cookie = key + "=" + value + expiry + "path=" + cookie.path;
                        }
                        else
                        {
                            document.cookie = key + "=" + value + expiry + ";domain=." + document.location.hostname + ";path=" + cookie.path;
                        }
